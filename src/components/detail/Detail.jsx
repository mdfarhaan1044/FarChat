...
const Detail = () => {
    ...
    const { chatId, isCurrentUserBlocked, isReceiverBlocked, changeBlock, user } = useChatStore();
        ...
        <div className="detail">
            ...
            <div className="info">
                ...
                <button onClick={handleBlock}>{
                    isReceiverBlocked ? "Unblock User" : isCurrentUserBlocked ? "You are blocked" : "Block User"
                }</button>
